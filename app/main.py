...
model = pickle.load(open("C:\\Users\\sriva\\Downloads\\TMC\\lightgbm_model.pkl", "rb"))
scaler = pickle.load(open("C:\\Users\\sriva\\Downloads\\TMC\\scaler.pkl", "rb"))
...
def get_clean_data():
    data = pd.read_excel("C:\\Users\\sriva\\Downloads\\TMC\\sem2_working_gbc_cleaned.xlsx")
    return data
...
def predict_survival(input_data):
    ...
    scaled_data = scaler.transform(pd.DataFrame([input_data]))
